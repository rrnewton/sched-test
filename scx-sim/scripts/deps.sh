...
dep() {
    ...
    rt-app)
        ...
        hint)  echo "build from https://github.com/scheduler-tools/rt-app, put it on PATH or set SCXSIM_RTAPP_BIN" ;;
        check) have rt-app || { [ -x "${SCXSIM_RTAPP_BIN:-}" ] && echo "$SCXSIM_RTAPP_BIN"; } \
